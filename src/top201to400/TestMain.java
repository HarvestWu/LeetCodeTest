...
public class TestMain {
    ...
    private static void test258() {
        int n = 38;
        int result = new Solution258().addDigits(n);
        System.out.println(result);
    }

    private static void test263() {
        int n = 90;
        boolean result = new Solution263().isUgly(n);
        System.out.println(result);
    }
    ...
    private static void test299() {
        String secret = "1122", guess = "1222";
        String result = new Solution299().getHint(secret, guess);
        System.out.println(result);
    }
